...
class Student:
    def __init__(self,root):
       ...
       dep_combo["values"]=("Select Depatment","Computer","IT","Civil","Mechnical")
       dep_combo.current(0)
       ...
       class_Student_frame=LabelFrame(Left_frame,bd=2,bg="white",fg="Red",relief=RIDGE,text="Class Student information",font=("times new roman",12,"bold"))
       class_Student_frame.place(x=5,y=130,width=720,height=350)
       ...
       roll_no_entry=ttk.Entry(class_Student_frame,textvariable=self.var_rollno,width=16,font=("times new roman",13,"bold"))
       ...
       address_entry=ttk.Entry(class_Student_frame,width=16,textvariable=self.var_address,font=("times new roman",13,"bold"))
       ...
       btn_frame.place(x=0,y=230,width=700,height=55)
       ...
       take_photo_btn=Button(btn_frame1,text="Take Photo Sample",command=self.generate_dataset,width=33,font=("times new roman",13,"bold"),bg="blue",fg="white")
       ...
       Right_frame.place(x=700,y=10,width=800,height=680)

       # ============Search System================
       Search_frame=LabelFrame(Right_frame,bd=2,bg="white",fg="Blue",relief=RIDGE,text="Search System",font=("times new roman",12,"bold"))
       ...
       table_frame.place(x=5,y=90,width=650,height=385)
    ...
    def add_data(self):
         if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            messagebox.showerror("Error","All Fields are required",parent=self.root)
             ...
             try:
                 conn=mysql.connector.connect(host="localhost",username="root",password="Sairam@123456",database="face_recognition")
            ...
            if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
                ...
                try:
                    ...
                    if Update>0:
                        ...
                        if not Update:
                            return
                    messagebox.showinfo("Success","Student details successfully update complited",parent=self.root)  
                    conn.commit()    
                    self.fetch_data()
                    conn.close()
                except Exception as es:
